...
from estimators.exporter import BestExporter, auc_bigger
from oss.oss_utils import list_odps_table_oss_files
from environ.config import set_tfconfig_environ
...
def main(_):
    ...
    train_files = list_odps_table_oss_files('tmp_v2_pai_train_data_for_like', FLAGS.buckets)
    if True:
        train_files.sort()
        part_files = []
    ...
    # train_files = ['../data/train_data.tsv']
    train_input_fn = lambda: create_dataset_from_file(part_files, FLAGS.batch_size,
                                                      num_epochs=FLAGS.num_epochs,
                                                      shuffle_buffer_size=FLAGS.shuffle_buffer_size)

    test_files = list_odps_table_oss_files('tmp_v2_pai_test_data_for_like', FLAGS.buckets)
    # test_files = ['../data/test_data.tsv']
